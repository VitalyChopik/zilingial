...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _libs_parallaxMouse__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/parallaxMouse */ \"./libs/parallaxMouse.js\");\n/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! aos */ \"../../node_modules/aos/dist/aos.js\");\n/* harmony import */ var _helpers_BaseHelpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/BaseHelpers */ \"./helpers/BaseHelpers.js\");\n/* harmony import */ var _modules_BurgerMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/BurgerMenu */ \"./modules/BurgerMenu.js\");\n/* harmony import */ var _section_bgAnimation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./section/bgAnimation */ \"./section/bgAnimation.js\");\n/* harmony import */ var _section_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./section/slider */ \"./section/slider.js\");\n/* harmony import */ var _section_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./section/form */ \"./section/form.js\");\n/* harmony import */ var _section_contacts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./section/contacts */ \"./section/contacts.js\");\n/* harmony import */ var _section_scrollAnimation__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./section/scrollAnimation */ \"./section/scrollAnimation.js\");\n/**\n * !(i)\n * Код попадает в итоговый файл, только когда вызвана функция, например FLSFunctions.spollers();\n * Или когда импортирован весь файл, например import \"files/script.js\";\n * Неиспользуемый код в итоговый файл не попадает.\n\n * Если мы хотим добавить модуль следует его раскомментировать\n */\n\n\n// import Swiper, { Navigation, Pagination } from 'swiper';\n\n\n// import PopupManager from './modules/PopupManager';\n\n\n\n\n\n\n// import Tabs from './modules/Tabs';\n// import Accordion from './modules/Accordion';\n\n_helpers_BaseHelpers__WEBPACK_IMPORTED_MODULE_2__[\"default\"].checkWebpSupport();\n_helpers_BaseHelpers__WEBPACK_IMPORTED_MODULE_2__[\"default\"].addTouchClass();\n_helpers_BaseHelpers__WEBPACK_IMPORTED_MODULE_2__[\"default\"].addLoadedClass();\n_helpers_BaseHelpers__WEBPACK_IMPORTED_MODULE_2__[\"default\"].headerFixed();\n\n/**\n * Открытие/закрытие модальных окон\n * Чтобы модальное окно открывалось и закрывалось\n * На окно повешай атрибут data-popup=\"<название окна>\"\n * На кнопку, которая вызывает окно повешай атрибут data-type=\"<название окна>\"\n\n * На обертку(.popup) окна добавь атрибут '[data-close-overlay]'\n * На кнопку для закрытия окна добавь класс '.button-close'\n * */\n// new PopupManager();\n\n/**\n *  Модуль для работы с меню (Бургер)\n * */\nnew _modules_BurgerMenu__WEBPACK_IMPORTED_MODULE_3__[\"default\"]().init();\n\n/**\n *  Библиотека для анимаций\n *  документация: https://michalsnik.github.io/aos\n * */\naos__WEBPACK_IMPORTED_MODULE_1__.init();\n\n/**\n * Параллакс мышей\n * */\nnew _libs_parallaxMouse__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n\n// new Tabs('tabs-example', {\n// \tonChange: (data) => {\n// \t\tconsole.log(data);\n// \t},\n// });\n\n// new Accordion('.accordion', {\n// \tshouldOpenAll: false, // true\n// \tdefaultOpen: [], // [0,1]\n// \tcollapsedClass: 'open',\n// });\n\nvar heroEffect = document.querySelectorAll('.hero__effects linearGradient');\nheroEffect ? (0,_section_bgAnimation__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(heroEffect) : null;\nvar sliderBlock = document.querySelector('.values__container');\nsliderBlock ? (0,_section_slider__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(sliderBlock) : null;\nvar chatbotLeftEffect = document.querySelectorAll('.chatbot__bg-left linearGradient');\nvar chatbotRightEffect = document.querySelectorAll('.chatbot__bg-right linearGradient');\nchatbotLeftEffect ? (0,_section_bgAnimation__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(chatbotLeftEffect) : null;\nchatbotRightEffect ? (0,_section_bgAnimation__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(chatbotRightEffect) : null;\nvar form = document.querySelector('.contacts__form');\nform ? (0,_section_form__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(form) : null;\nvar contactsTitle = document.querySelector('.contacts__title');\ncontactsTitle ? (0,_section_contacts__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(contactsTitle) : null;\nvar inputBoxs = document.querySelectorAll('.contacts__form-box');\n\n// Добавляем обработчик события для каждого input\ninputBoxs.forEach(function (inputBox) {\n  var input = inputBox.querySelector('.contacts__form-input');\n  var label = inputBox.querySelector('.contacts__form-label');\n  input.addEventListener('input', function () {\n    if (this.value.trim().length > 0) {\n      // Используйте trim(), чтобы игнорировать пробелы\n      input.classList.add('active');\n    } else {\n      input.classList.remove('active');\n    }\n    label.style.display = this.value ? 'none' : 'flex';\n  });\n});\n(0,_section_scrollAnimation__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\nvar popup = document.querySelector('.popup');\nif (popup) {\n  var preventDefaults = function preventDefaults(e) {\n    e.preventDefault();\n    e.stopPropagation();\n  };\n  var highlight = function highlight() {\n    dropArea.classList.add('highlight');\n  };\n  var unhighlight = function unhighlight() {\n    dropArea.classList.remove('highlight');\n  };\n  var handleDrop = function handleDrop(e) {\n    var dt = e.dataTransfer;\n    var files = dt.files;\n\n    // Устанавливаем файл в input\n    fileInput.files = files;\n    handleFiles(files);\n  };\n  var handleFileSelect = function handleFileSelect() {\n    var files = this.files;\n    handleFiles(files);\n  };\n  var handleFiles = function handleFiles(files) {\n    if (files.length > 0) {\n      // Выполните здесь необходимые действия с загруженными файлами\n      customFile.textContent = files[0].name;\n    }\n  };\n  var fileInput = popup.querySelector('#fileInput');\n  var customFile = popup.querySelector('.contacts__form-file');\n  var dropArea = popup.querySelector('#dropArea');\n\n  // Предотвращаем стандартные действия при перетаскивании файлов\n  ['dragover', 'dragenter', 'dragleave', 'drop'].forEach(function (eventName) {\n    dropArea.addEventListener(eventName, preventDefaults, false);\n    document.body.addEventListener(eventName, preventDefaults, false);\n  });\n\n  // Обработчики событий для подсветки области при перетаскивании\n  ['dragenter', 'dragover'].forEach(function (eventName) {\n    dropArea.addEventListener(eventName, highlight, false);\n  });\n  ['dragleave', 'drop'].forEach(function (eventName) {\n    dropArea.addEventListener(eventName, unhighlight, false);\n  });\n\n  // Обработчик события drop для загрузки файла\n  dropArea.addEventListener('drop', handleDrop, false);\n\n  // Обработчик события click для открытия диалогового окна выбора файла\n  customFile.addEventListener('click', function () {\n    fileInput.click();\n  });\n\n  // Обработчик изменения файла\n  fileInput.addEventListener('change', handleFileSelect);\n  (0,_section_form__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(popup);\n  var expertiseBoxs = document.querySelectorAll('.expertise__box');\n  expertiseBoxs.forEach(function (expertiseBox) {\n    var button = expertiseBox.querySelector('.expertise__box-btn');\n    var title = expertiseBox.querySelector('.expertise__box-title');\n    var popupTitle = popup.querySelector('input[name=\"Form\"]');\n    button.addEventListener('click', function () {\n      popupTitle.value = title.textContent;\n      popup.classList.add('open');\n      document.documentElement.classList.add('lock');\n    });\n  });\n  var popupCloses = popup.querySelectorAll('.popup__wrapper, .popup__close');\n  popupCloses.forEach(function (popupClose) {\n    popupClose.addEventListener('click', function () {\n      popup.classList.remove('open');\n      document.documentElement.classList.remove('lock');\n    });\n  });\n}\n\n//# sourceURL=webpack:///./main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar contacts = function contacts(contactsTitle) {\n  var text = contactsTitle.textContent;\n  var spannedText = text.split('').map(function (char) {\n    return \"<span>\".concat(char, \"</span>\");\n  }).join('');\n  contactsTitle.innerHTML = spannedText;\n  var spans = Array.from(contactsTitle.querySelectorAll('span')); // Преобразование NodeList в массив\n\n  var isInViewport = false;\n  var addActiveClass = function addActiveClass() {\n    if (spans.length > 0) {\n      spans[0].classList.add('active');\n      spans.shift();\n    } else {\n      window.removeEventListener('scroll', scrollHandler);\n    }\n  };\n  var scrollHandler = function scrollHandler() {\n    var rect = contactsTitle.getBoundingClientRect();\n    if (rect.top <= window.innerHeight && rect.bottom >= 0 && !isInViewport) {\n      isInViewport = true;\n      addActiveClass();\n      setInterval(addActiveClass, 200);\n    }\n  };\n  window.addEventListener('scroll', scrollHandler);\n  scrollHandler(); //\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (contacts);\n\n//# sourceURL=webpack:///./section/contacts.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar formBlock = function formBlock(_formBlock) {\n  var spinner = _formBlock.querySelector('.spinner');\n  var form = _formBlock.querySelector('.contacts__form-content');\n  var formSubmit = form.querySelector('.contacts__form-button');\n  var inputsBox = form.querySelectorAll('.contacts__form-box');\n  form.addEventListener('submit', function (e) {\n    e.preventDefault();\n    if (validateInputs(inputsBox)) {\n      sendData();\n    }\n  });\n  function validateInputs(inputsBox) {\n    var isValid = true;\n    inputsBox.forEach(function (box) {\n      var requiredInputs = box.querySelectorAll('.required');\n      requiredInputs.forEach(function (input) {\n        if (input.value.trim() === '') {\n          isValid = false;\n          box.classList.add('error');\n        } else {\n          box.classList.remove('error');\n        }\n      });\n    });\n    return isValid;\n  }\n  function sendData() {\n    spinner.classList.add('active');\n    var fileInput = form.querySelector('.contacts__form-file-hidden');\n    var formData = new FormData(form);\n    if (fileInput) {\n      var files = fileInput.files;\n      if (files.length > 0) {\n        formData.append('attachment', files[0]);\n      }\n    }\n    // fetch('https://formsubmit.co/support@zilingial.com', {\n    fetch('https://formsubmit.co/support@zilingial.com', {\n      method: 'POST',\n      body: formData\n    }).then(function (response) {\n      return response.text();\n    }).then(function (data) {\n      spinner.classList.remove('active');\n      _formBlock.classList.toggle('success');\n    }).catch(function (error) {\n      console.error('Error sending data:', error);\n    });\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (formBlock);\n\n//# sourceURL=webpack:///./section/form.js?");

/***/ }),

/***/ "./section/scrollAnimation.js":
/*!************************************!*\
  !*** ./section/scrollAnimation.js ***!
  \************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ \"../../node_modules/gsap/index.js\");\n/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/ScrollTrigger */ \"../../node_modules/gsap/ScrollTrigger.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : String(i); }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\n\n\nvar scrollAnimation = function scrollAnimation() {\n  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);\n  var about = document.querySelector('.about');\n  if (about) {\n    var aboutBoxs = about.querySelectorAll('.about__box');\n    aboutBoxs.forEach(function (item) {\n      var aboutAnim = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({\n        scrollTrigger: _defineProperty({\n          trigger: about,\n          start: function start() {\n            return \"top 70%\";\n          },\n          end: function end() {\n            return \"bottom 70%\";\n          },\n          markers: false,\n          scrub: true\n        }, \"markers\", false)\n      });\n      var bg = item.querySelector('.about__box-bg');\n      aboutAnim.fromTo(bg, {\n        height: 0\n      }, {\n        height: \"100%\"\n      });\n    });\n  }\n  var values = document.querySelector('.values');\n  if (values) {\n    var valuesBoxs = document.querySelectorAll('.values__box');\n    valuesBoxs.forEach(function (item) {\n      var valuesAnim = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({\n        scrollTrigger: _defineProperty({\n          trigger: values,\n          start: function start() {\n            return \"top top\";\n          },\n          end: function end() {\n            return \"bottom bottom\";\n          },\n          markers: false,\n          scrub: true\n        }, \"markers\", false)\n      });\n      var bg = item.querySelector('.values__box-bg');\n      valuesAnim.fromTo(bg, {\n        width: 0,\n        height: 0\n      }, {\n        width: 130,\n        height: 130\n      });\n    });\n  }\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (scrollAnimation);\n\n//# sourceURL=webpack:///./section/scrollAnimation.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ \"../../node_modules/swiper/swiper.esm.js\");\n\nvar slider = function slider(sliderBlock) {\n  var sliderStatus = null;\n  function initSliders() {\n    if (window.innerWidth < 992) {\n      sliderStatus = new swiper__WEBPACK_IMPORTED_MODULE_0__[\"default\"](sliderBlock, {\n        modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],\n        centeredSlides: true,\n        slidesPerView: 1,\n        spaceBetween: 0,\n        pagination: {\n          el: '.swiper-pagination',\n          clickable: true\n        }\n        // autoHeight: true,\n      });\n    } else {\n      sliderStatus.destroy();\n      sliderStatus = null;\n    }\n  }\n  if (window.innerWidth < 992) {\n    window.addEventListener('load', initSliders);\n  }\n  window.addEventListener('resize', initSliders);\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (slider);\n\n//# sourceURL=webpack:///./section/slider.js?");
